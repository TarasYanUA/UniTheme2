...
public class Menu21_Vertical_ColumnFilling_5columns_FullView extends TestRunner {
    ...
    public void check_Menu21_Vertical_ColumnFilling_5columns_FullView(){
        ...
        takeScreenShot("Menu21.00 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu AllProducts");
        ...
        takeScreenShot("Menu21.02 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu Electronic");
        ...
        takeScreenShot("Menu21.04 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu Apparel");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu21.06 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu SportsAndOutdoors");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu21.08 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu VideoGames");

        stHomePage.menuButton_Catalog.click();
        stHomePage.selectLanguage_RTL();
        stHomePage.menuButton_Catalog.click();
        stHomePage.navigateToMenu_AllProducts();
        takeScreenShot("Menu21.10 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu AllProducts (RTL)");
        stHomePage.navigateToMenu_Electronic();
        takeScreenShot("Menu21.12 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu Electronic (RTL)");
        stHomePage.navigateToMenu_Apparel();
        takeScreenShot("Menu21.14 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu Apparel (RTL)");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu21.16 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu SportsAndOutdoors (RTL)");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu21.18 menu.Menu21_Vertical_ColumnFilling_5columns_FullView - Menu VideoGames (RTL)");
