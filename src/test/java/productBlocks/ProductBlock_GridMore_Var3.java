...
public class ProductBlock_GridMore_Var3 extends TestRunner implements DisableLazyLoadFromSection {
    ...
    public void setConfigurationsForProductBlock_GridMore_Var3() {
        ...
        basicPage.clickAndType_Field_NumberOfColumnsInList("6");
        ...
        WebElement checkbox_EmptyStarsOfProductRating = themeSettingsProductLists.setting_EmptyStarsOfProductRating;
