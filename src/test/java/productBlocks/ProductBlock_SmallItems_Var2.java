...
public class ProductBlock_SmallItems_Var2 extends TestRunner implements DisableLazyLoadFromSection {
    String blockID;
    Asserts_ThemeSettings_ProductLists asserts_productLists = new Asserts_ThemeSettings_ProductLists();

    @Test(priority = 1)
    public void setConfigurationsFor_ProductBlock_SmallItems_Var2() {
        ...
        new Select(themeSettingsProductLists.smallItems_NumberOfLinesInProductName).selectByValue("3");
        ...
        new Select(themeSettingsProductLists.smallItems_AddToCartButton).selectByValue("icon_button");
    ...
    public void checkProductBlock_SmallItems_Var2(){
        ...
        softAssert.assertTrue(!assertsOnStorefront.getNumberOfLinesInProductName_SmallItems(blockID, 3).isEmpty(),
