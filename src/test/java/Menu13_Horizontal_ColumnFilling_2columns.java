...
public class Menu13_Horizontal_ColumnFilling_2columns extends TestRunner{
    ...
    public void check_Menu13_Horizontal_ColumnFilling_2columns(){
        ...
        takeScreenShot_withoutScroll("Menu13.00 Menu13_Horizontal_ColumnFilling_2columns - Menu AllProducts");
        ...
        takeScreenShot_withoutScroll("Menu13.02 Menu13_Horizontal_ColumnFilling_2columns - Menu Electronic");
        ...
        takeScreenShot_withoutScroll("Menu13.04 Menu13_Horizontal_ColumnFilling_2columns - Menu Apparel");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot_withoutScroll("Menu13.06 Menu13_Horizontal_ColumnFilling_2columns - Menu SportsAndOutdoors");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot_withoutScroll("Menu13.08 Menu13_Horizontal_ColumnFilling_2columns - Menu VideoGames");

        stHomePage.selectLanguage_RTL();
        stHomePage.navigateToMenu_Electronic();
        takeScreenShot_withoutScroll("Menu13.10 Menu13_Horizontal_ColumnFilling_2columns - Menu Electronic (RTL)");
        stHomePage.navigateToMenu_Apparel();
        takeScreenShot_withoutScroll("Menu13.12 Menu13_Horizontal_ColumnFilling_2columns - Menu Apparel (RTL)");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot_withoutScroll("Menu13.14 Menu13_Horizontal_ColumnFilling_2columns - Menu SportsAndOutdoors (RTL)");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot_withoutScroll("Menu13.16 Menu13_Horizontal_ColumnFilling_2columns - Menu VideoGames (RTL)");
