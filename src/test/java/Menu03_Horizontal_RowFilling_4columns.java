...
public class Menu03_Horizontal_RowFilling_4columns extends TestRunner{
    ...
    public void check_Menu03_Horizontal_RowFilling_4columns(){
        ...
        takeScreenShot_withoutScroll("Menu3.00 Menu03_Horizontal_RowFilling_4columns - Menu AllProducts");
        ...
        takeScreenShot_withoutScroll("Menu3.02 Menu03_Horizontal_RowFilling_4columns - Menu Electronic");
        ...
        takeScreenShot_withoutScroll("Menu3.04 Menu03_Horizontal_RowFilling_4columns - Menu Apparel");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot_withoutScroll("Menu3.06 Menu03_Horizontal_RowFilling_4columns - Menu SportsAndOutdoors");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot_withoutScroll("Menu3.08 Menu03_Horizontal_RowFilling_4columns - Menu VideoGames");

        stHomePage.selectLanguage_RTL();
        stHomePage.navigateToMenu_Electronic();
        takeScreenShot_withoutScroll("Menu3.10 Menu03_Horizontal_RowFilling_4columns - Menu Electronic (RTL)");
        stHomePage.navigateToMenu_Apparel();
        takeScreenShot_withoutScroll("Menu3.12 Menu03_Horizontal_RowFilling_4columns - Menu Apparel (RTL)");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot_withoutScroll("Menu3.14 Menu03_Horizontal_RowFilling_4columns - Menu SportsAndOutdoors (RTL)");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot_withoutScroll("Menu3.16 Menu03_Horizontal_RowFilling_4columns - Menu VideoGames (RTL)");
