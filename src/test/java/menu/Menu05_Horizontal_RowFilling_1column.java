...
public class Menu05_Horizontal_RowFilling_1column extends TestRunner {
    ...
    public void check_Menu05_Horizontal_RowFilling_1column(){
        ...
        takeScreenShot("Menu5.00 menu.Menu05_Horizontal_RowFilling_1column - Menu AllProducts");
        ...
        takeScreenShot("Menu5.02 menu.Menu05_Horizontal_RowFilling_1column - Menu Electronic");
        ...
        takeScreenShot("Menu5.04 menu.Menu05_Horizontal_RowFilling_1column - Menu Apparel");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu5.06 menu.Menu05_Horizontal_RowFilling_1column - Menu SportsAndOutdoors");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu5.08 menu.Menu05_Horizontal_RowFilling_1column - Menu VideoGames");

        stHomePage.selectLanguage_RTL();
        stHomePage.navigateToMenu_Electronic();
        takeScreenShot("Menu5.10 menu.Menu05_Horizontal_RowFilling_1column - Menu Electronic (RTL)");
        stHomePage.navigateToMenu_Apparel();
        takeScreenShot("Menu5.12 menu.Menu05_Horizontal_RowFilling_1column - Menu Apparel (RTL)");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu5.14 menu.Menu05_Horizontal_RowFilling_1column - Menu SportsAndOutdoors (RTL)");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu5.16 menu.Menu05_Horizontal_RowFilling_1column - Menu VideoGames (RTL)");
