...
public class Menu10_Horizontal_ColumnFilling_6columns extends TestRunner {
    ...
    public void check_Menu10_Horizontal_ColumnFilling_6columns(){
        ...
        takeScreenShot("Menu10.00 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu AllProducts");
        ...
        takeScreenShot("Menu10.02 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu Electronic");
        ...
        takeScreenShot("Menu10.04 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu Apparel");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu10.06 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu SportsAndOutdoors");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu10.08 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu VideoGames");

        stHomePage.selectLanguage_RTL();
        stHomePage.navigateToMenu_Electronic();
        takeScreenShot("Menu10.10 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu Electronic (RTL)");
        stHomePage.navigateToMenu_Apparel();
        takeScreenShot("Menu10.12 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu Apparel (RTL)");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu10.14 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu SportsAndOutdoors (RTL)");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu10.16 menu.Menu10_Horizontal_ColumnFilling_6columns - Menu VideoGames (RTL)");
