...
public class ColorSchemeSettings_General_Var2 extends TestRunner{
    ...
    public void checkColorSchemeSettings_General_Var2(){
        ...
        takeScreenShot_withoutScroll("2150 ColorScheme, General, Var2 - Block with products");
        stHomePage.selectLanguage_RTL();
        stHomePage.scrollToBlockWithProducts();
        stHomePage.hoverToProductInProductBlock();
        takeScreenShot_withoutScroll("2155 ColorScheme, General, Var2 - Block with products (RTL)");
        ...
        takeScreenShot("2160 ColorScheme, General, Var2 - Category page");
        stCategoryPage.clickQuickViewOfPhoneProduct();
        takeScreenShot("2165 ColorScheme, General, Var2 - QuickView");
        stCategoryPage.clickButton_WriteReview();
        takeScreenShot("2170 ColorScheme, General, Var2 - Write review");
        stCategoryPage.closeWriteReview.click();
        stCategoryPage.clickCloseQuickView();
        stHomePage.selectLanguage_RTL();
        stCategoryPage.hoverToPhoneProduct();
        takeScreenShot("2175 ColorScheme, General, Var2 - Category page (RTL)");
        stCategoryPage.clickQuickViewOfPhoneProduct();
        takeScreenShot("2180 ColorScheme, General, Var2 - QuickView (RTL)");
        stCategoryPage.clickButton_WriteReview();
        takeScreenShot("2185 ColorScheme, General, Var2 - Write review (RTL)");
    }
}