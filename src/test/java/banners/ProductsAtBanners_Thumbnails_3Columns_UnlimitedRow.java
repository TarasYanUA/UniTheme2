...
public class ProductsAtBanners_Thumbnails_3Columns_UnlimitedRow extends TestRunner {
    String bannerName = "Auto banner with products - SmallElements_3Columns_UnlimitedRow";
    String blockID;
    Asserts_Banners assertsBanners = new Asserts_Banners();

    @Test(priority = 1)
    public void setProductsAtBanners_SmallElements_3Columns_UnlimitedRow() {
    ...
    @Test(priority = 2, dependsOnMethods = "setProductsAtBanners_SmallElements_3Columns_UnlimitedRow")
    public void checkProductsAtBanners_SmallElements_3Columns_UnlimitedRow() {
        BasicPage basicPage = new BasicPage();
        ...
        assertsBanners.assertNumberOfColumns(assertsBanners.columnsOfProducts_Thumbnails, 3);
