...
public class Menu12_Horizontal_ColumnFilling_4columns extends TestRunner {
    ...
    public void check_Menu12_Horizontal_ColumnFilling_4columns(){
        ...
        takeScreenShot("Menu12.00 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu AllProducts");
        ...
        takeScreenShot("Menu12.02 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu Electronic");
        ...
        takeScreenShot("Menu12.04 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu Apparel");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu12.06 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu SportsAndOutdoors");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu12.08 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu VideoGames");

        stHomePage.selectLanguage_RTL();
        stHomePage.navigateToMenu_Electronic();
        takeScreenShot("Menu12.10 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu Electronic (RTL)");
        stHomePage.navigateToMenu_Apparel();
        takeScreenShot("Menu12.12 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu Apparel (RTL)");
        stHomePage.navigateToMenu_SportsAndOutdoors();
        takeScreenShot("Menu12.14 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu SportsAndOutdoors (RTL)");
        stHomePage.navigateToMenu_VideoGames();
        takeScreenShot("Menu12.16 menu.Menu12_Horizontal_ColumnFilling_4columns - Menu VideoGames (RTL)");
