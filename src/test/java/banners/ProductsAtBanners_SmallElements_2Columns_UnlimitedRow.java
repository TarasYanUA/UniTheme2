...
public class ProductsAtBanners_SmallElements_2Columns_UnlimitedRow extends TestRunner {
    String bannerName = "Auto banner with products - SmallElements_2Columns_UnlimitedRow";
    String blockID;
    Asserts_Banners assertsBanners = new Asserts_Banners();

    @Test(priority = 1)
    public void setProductsAtBanners_SmallElements_2Columns_UnlimitedRow() {
    ...
    @Test(priority = 2, dependsOnMethods = "setProductsAtBanners_SmallElements_2Columns_UnlimitedRow")
    public void checkProductsAtBanners_SmallElements_2Columns_UnlimitedRow() {
        BasicPage basicPage = new BasicPage();
